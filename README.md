...
#### Please note: I settle for concrete class BalanceProcessing because using class interface was a bit messy especially passing argument to every function. Also because this is a small application.
